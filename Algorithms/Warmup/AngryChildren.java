...
// The part of the program involving reading from STDIN and writing to STDOUT has been provided by
// us.
...
public class AngryChildren {
  ...
  public static void main(String[] args) throws NumberFormatException, IOException {
    ...
    Arrays.sort(packets);
    for (int i = numKids - 1, first = 0; i < numPackets; i++, first++) {
      unfairness = Math.min(packets[i] - packets[first], unfairness);
    }
    //
